...
<p>The script wields the power of WebDriver Manager to summon the perfect web driver for your browser. Ensure you have a compatible BROWSER DRIVER installed in your operating system from the following site by pasting the link infront of the suitable driver to a new tab:</p>
